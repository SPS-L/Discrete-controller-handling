%% %% This file solves the RTE PI controller using IBM
...
figure(1)
plot(times,xhist(2,:),'cx')
xlabel('Time (s)','FontSize', 24)
ylabel('y_{2}','FontSize', 24)
set(gca,'FontSize',18)
xlim([0 tsim])
legend('SRM','ATM','SSM','IBM','Location','northwest')
...
if save==1
    hgexport(gcf,'PSCCSinglePI.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'PSCCSinglePIZ.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'PSCCSinglePIstep.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'PSCCsinglepierror.pdf',figure_property);
end
