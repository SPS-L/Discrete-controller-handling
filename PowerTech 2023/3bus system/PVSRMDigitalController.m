...
%     end
    ...
    if t<min(T)
        ...
        [t1,conti,tg,mm]=detert(tpre1,t,tg,T,cn,tsim); %Finding the event if there is any
        if mm==0
            etpre2=etpre;
            etpre=et;
            et=et;
...
set(gca,'FontSize',18)
legend('Analog fixed time steps','Analog variable time steps','Digital (T_{G}=0.2,T_{E}=0.05)','Location','southeast')
...
set(gca,'FontSize',18)
legend('Analog fixed time steps','Analog variable time steps','Digital (T_{G}=0.2,T_{E}=0.05)','Location','northeast')
set(gca, 'FontName', 'Times New Roman')
xlim([0 tsim])
box on
figure_property.units = 'inches';
...
set(gca,'FontSize',18)
legend('Analog fixed time steps','Analog variable time steps','Digital (T_{G}=0.2,T_{E}=0.05)','Location','northwest')
set(gca,'FontSize',18)
xlim([0 tsim])
box on
figure_property.units = 'inches';
