%% %% This file solves the anti-windup PI controller using SRM (Digital)(StepInput)
clear all
clc
tic
...
global T;
T=0.2; %Controller sampling time 
...
%     %Setting new and old controllers's signal
    ...
    elseif tg>tpre1 && tg<=t+0.00000001
        ...
        et1pre=et1;
        if et>wmin && et<wmax
            x=ki*(u-kf*xxq(2,1))*T+x;
        else
            x=x;
        end
        et=kp*(u-kf*xxq(2,1))+x;
...
ylabel('Controller Output (w)','FontSize', 24)
set(gca,'FontSize',18)
legend('Analog','Digital (T=0.001)','Digital (T=0.002)','Digital (T=0.02)','Digital (T=0.2)','Location','southeast')
...
if save==1
    hgexport(gcf,'C:\Users\mjafa\Desktop\Coding tutorial\MATLAB\PI controller paper\PIFeedbackstepController.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'C:\Users\mjafa\Desktop\Coding tutorial\MATLAB\PI controller paper\PIFeedbackstepSystem.pdf',figure_property);
end
