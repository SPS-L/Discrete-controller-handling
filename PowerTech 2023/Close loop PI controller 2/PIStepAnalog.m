%% %% This file solves the anti-windup PI controller using SRM (Analog)(StepInput)
clear all
clc
tic
...
while t<tsim
    ...
    xx0=predictor(xx,xpre1,t,tpre1,h,betha1,betha2,dae,u); %predictor
    [alpha0,alpha1,alpha2,betha1,betha2]=coefs(cc,h,holdd); %calculating the coefficients of the corrector
    [iterations,xx]=NewtonNL(h,xx0,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u); %The main function (Newton solver)
...
function [iterations,xx]=NewtonNL(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u)
...
a=1;
    ...
    [J]=Jacob(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u); %calculating the Jacobian
    yy=xx-J\func(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u); %Newton
    xx=yy;
    a=abs(xx-xxpre);
    a=max(a);
    if iterations==10
...
function [J]=Jacob(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u)
s=size(xx);
s=s(1);
delta=1e-6;
i=0;
...
while i<s
    i=i+1;
    f0=func(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u);
    yy=xx;
    yy(i)=xx(i)+delta;
    f1=func(h,yy,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u);
    J(:,i)=(f1-f0)/delta;
end
end

% This function determines the predictor formulation
function [xxp]=predictor(xx,xpre1,t,tpre1,h,betha1,betha2,dae,u)
    xxp1=xx+h*(((betha1)*evaleval(xx,t,u))+((betha2)*evaleval(xpre1,tpre1,u)));
    xxp2=xx+evaleval(xx,t,u);
...
function [f]=func(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,t,dae,u) 
    f1=h*(betha1*evaleval(xx,t,u)+betha2*evaleval(xpre1,tpre1,u))+(alpha0*xx)+(alpha1*xpre1)+(alpha2*xpre2);
    f2=evaleval(xx,t,u);
