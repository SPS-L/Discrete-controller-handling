%% %% This file solves the synchronous machine infinite bus example using the decoupled interpolation based method (DIBM)
...
legend('V_{g} (SRM)','V_{g} (IBM)','V_{g} (DIBM)','Location','southeast')
...
if save==1
    hgexport(gcf,'SysconSMIBvoltage.pdf',figure_property);
end
...
set(gca,'FontSize',18)
legend('I_{g} (SRM)','I_{g} (IBM)','I_{g} (DIBM)','Location','northeast')
set(gca, 'FontName', 'Times New Roman')
xlim([0 tsim])
figure_property.units = 'inches';
figure_property.format = 'pdf';
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBcurrent.pdf',figure_property);
end
...
set(gca,'FontSize',18)
legend('SRM','IBM','DIBM','Location','southeast')
set(gca, 'FontName', 'Times New Roman')
xlim([0 tsim])
figure_property.units = 'inches';
figure_property.format = 'pdf';
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBspeed.pdf',figure_property);
end
...
set(gca,'FontSize',18)
legend('SRM','IBM','DIBM','Location','northeast')
set(gca, 'FontName', 'Times New Roman')
xlim([0 tsim])
figure_property.units = 'inches';
figure_property.format = 'pdf';
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBdelta.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBtorquesignal.pdf',figure_property);
%     hgexport(gcf,'SysconSMIBIBMQuantizationTest.pdf.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBavrsignal.pdf',figure_property);
end
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBfrequency.pdf',figure_property);
end
...
set(gca,'FontSize',18)
legend('SRM','IBM','DIBM','Location','northwest')
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBstepsize.pdf',figure_property);
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBP.pdf',figure_property);
end
hold on
figure(21)
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconSMIBRP.pdf',figure_property);
end
