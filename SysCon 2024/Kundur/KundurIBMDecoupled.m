...
%     end
    ...
    [iterations,xx,eg,tg,feeg,eeg,avrov,fitert,dhiterations]=NewtonNL(h,xx0,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,tpre2,t,sg,eg,T,tg,ee0gm,ee0gv,egpre,cn,cq,dae,avrovpre,avrovmm1,avrovmm2,avrovmm3,avrovmm4,holdd,cnhist); %The main function (Newton solver)
...
legend('V_{1} (SRM)','V_{4} (SRM)','V_{9} (SRM)','V_{1} (IBM)','V_{4} (IBM)','V_{9} (IBM)','V_{1} (DIBM)','V_{4} (DIBM)','V_{9} (DIBM)','Location','northeast')
set(gca,'FontSize',18)
xlim([0 tsim])
...
if save==1
    hgexport(gcf,'SysconKundurVoltage.pdf',figure_property);
end
...
legend('Gov1 (SRM)','Gov2 (SRM)','Gov3 (SRM)','Gov4 (SRM)','Gov1 (IBM)','Gov2 (IBM)','Gov3 (IBM)','Gov4 (IBM)','Gov1 (DIBM)','Gov2 (DIBM)','Gov3 (DIBM)','Gov4 (DIBM)','Location','northeast')
set(gca,'FontSize',18)
xlim([0 tsim])
figure_property.units = 'inches';
figure_property.format = 'pdf';
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconKundurGovernor.pdf',figure_property);
end
figure (32) %Exciter
plot(times,ehist(5,:),'*')
hold on
...
legend('Exc1 (SRM)','Exc2 (SRM)','Exc3 (SRM)','Exc4 (SRM)','Exc1 (IBM)','Exc2 (IBM)','Exc3 (IBM)','Exc4 (IBM)','Exc1 (DIBM)','Exc2 (DIBM)','Exc3 (DIBM)','Exc4 (DIBM)','Location','northeast')
set(gca,'FontSize',18)
xlim([0 tsim])
figure_property.units = 'inches';
figure_property.format = 'pdf';
...
set(chosen_figure,'Units','inches');
if save==1
    hgexport(gcf,'SysconKundurExciter.pdf',figure_property);
end
...
function [iterations,xx,eg,tg,feeg,eegv,avrov,fitert,dhiterations]=NewtonNL(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,tpre2,t,sg,eg,T,tg,eegm,eegv,egpre,cn,cq,dae,avrovpre,avrovmm1,avrovmm2,avrovmm3,avrovmm4,holdd,cnhist)
...
%         [JJ,fiter]=Jacob2(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,eg,egpre,t,dae,sg,eegm,cn,cnhist); %Simplified Jacobian with B
%         [JJ,fiter]=Jacob1(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,eg,egpre,t,dae,sg); %Simplified Jacobian
        [JJ,fiter]=Jacob0(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,eg,egpre,t,dae,sg); %Only system's Jacobian
        fitert=fitert+fiter;
...
function [J,fiter]=Jacob0(h,xx,xpre1,xpre2,alpha1,alpha2,alpha0,betha1,betha2,tpre1,eg,egpre,t,dae,sg)
s=size(xx);
s=s(1);
delta=1e-4;
i=0;
